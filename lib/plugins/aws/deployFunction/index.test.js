  ...
  describe('#deployFunction()', () => {
    ...
    beforeEach(() => {
      ...
      awsDeployFunction.remoteFunctionData = {
        Configuration: {
          CodeSha256: 'some-different-remote-hash',
        },
      };
    });
    ...
    it('should resolve of the function if the hashes are the same', () => {
      // awnY7Oi280gp5kTCloXzsqJCO4J766x6hATWqQsN/uM= <-- hash of the local zip file
      readFileSyncStub.returns(new Buffer('my-service.zip content'));
      awsDeployFunction.remoteFunctionData
        .Configuration.CodeSha256 = 'awnY7Oi280gp5kTCloXzsqJCO4J766x6hATWqQsN/uM=';
